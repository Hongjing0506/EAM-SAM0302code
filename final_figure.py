...
LastEditors: ChenHJ
LastEditTime: 2022-07-06 21:16:39
FilePath: /chenhj/0302code/final_figure.py
Aim: 
In this file, we will change the 
Mission: 
'''
# %%
...
vorssp585_p3_cli_ver_JJA = vorssp585_p3_ver_JJA.mean(dim="time", skipna=True)
# %%
...
axs[0].plot(np.arange(2015,2100,1), pressp585_p3_India_JJA.sel(models=gmodels).mean(dim="models",skipna=True), color="black", lw=1.2)
...
# axs[0].line(models_array, IndR_200hgt_pcc[:-2], zorder=1, cycle=cycles, label="NCR_200", marker="o")
