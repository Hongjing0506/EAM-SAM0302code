...
wind_ERA5_SAM_regress_mask = ca.wind_check(
...
wind_his_SAM_regress_mask = ca.wind_check(
    xr.where(u_his_SAM_regress["pvalue"] <= 0.05, 1.0, 0.0), 
    xr.where(v_his_SAM_regress["pvalue"] <= 0.05, 1.0, 0.0), 
    0.5, 
    0.5)
# %%
hgt_his_SAM_regress_ens = hgt_his_SAM_regress.mean(dim="models", skipna=True)
u_his_SAM_regress_ens = u_his_SAM_regress.mean(dim="models", skipna=True)
v_his_SAM_regress_ens = v_his_SAM_regress.mean(dim="models", skipna=True)

hgt_his_SAM_regress_ens_mask = ca.MME_reg_mask(hgt_his_SAM_regress_ens["slope"], hgt_his_SAM_regress["slope"].std(dim="models", skipna=True), len(hgt_his_SAM_regress.coords["models"]), True)
u_his_SAM_regress_ens_mask = ca.MME_reg_mask(u_his_SAM_regress_ens["slope"], u_his_SAM_regress["slope"].std(dim="models", skipna=True), len(u_his_SAM_regress.coords["models"]), False)
v_his_SAM_regress_ens_mask = ca.MME_reg_mask(v_his_SAM_regress_ens["slope"], v_his_SAM_regress["slope"].std(dim="models", skipna=True), len(v_his_SAM_regress.coords["models"]), False)

wind_his_SAM_regress_ens_mask = ca.wind_check(u_his_SAM_regress_ens["slope"], v_his_SAM_regress_ens["slope"], u_his_SAM_regress_ens_mask, v_his_SAM_regress_ens_mask)
# %%
#   plot the hgt/u/v regress onto SAM index
startlim = [-24, -16, -10]
endlim = [24, 16, 10]
spacing = [1, 1, 1]
for i, lev in enumerate(hgt_ERA5_SAM_slope.coords["level"]):
    pplt.rc.grid = False
    pplt.rc.reso = "lo"
    cl = 0  # 设置地图投影的中心纬度
    proj = pplt.PlateCarree(central_longitude=cl)
    ...
    # ===================================================
    con = axs[0].contourf(
    hgt_ERA5_SAM_slope.sel(level=lev),
    cmap="ColdHot",
    cmap_kw={"left": 0.06, "right": 0.94, "cut": -0.1},
    ...
    sepl.plt_sig(
        hgt_ERA5_SAM_slope.sel(level=lev), axs[0], n, np.where(hgt_ERA5_SAM_pvalue.sel(level=lev)[::n, ::n] <= 0.05), "denim", 3.0,
    )
    axs[0].quiver(
        u_ERA5_SAM_slope.sel(level=lev)[::ski, ::ski],
        v_ERA5_SAM_slope.sel(level=lev)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
    ...
    m = axs[0].quiver(
        u_ERA5_SAM_slope.sel(level=lev).where(wind_ERA5_SAM_regress_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        v_ERA5_SAM_slope.sel(level=lev).where(wind_ERA5_SAM_regress_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
    ...
    # ===================================================
    con = axs[1].contourf(
    hgt_his_SAM_regress_ens["slope"].sel(level=lev),
    cmap="ColdHot",
    cmap_kw={"left": 0.06, "right": 0.94, "cut": -0.1},
    levels=np.arange(startlim[i], endlim[i]+spacing[i], spacing[i]),
    zorder=0.8,
    ...
    sepl.plt_sig(
        hgt_his_SAM_regress_ens["slope"].sel(level=lev), axs[1], n, np.where(hgt_his_SAM_regress_ens_mask.sel(level=lev)[::n, ::n] > 0.0), "denim", 3.0,
    )
    axs[1].quiver(
        u_his_SAM_regress_ens["slope"].sel(level=lev)[::ski, ::ski],
        v_his_SAM_regress_ens["slope"].sel(level=lev)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
    ...
    m = axs[1].quiver(
        u_his_SAM_regress_ens["slope"].sel(level=lev).where(wind_his_SAM_regress_ens_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        v_his_SAM_regress_ens["slope"].sel(level=lev).where(wind_his_SAM_regress_ens_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
    ...
    #===================================================
    for num_models, mod in enumerate(hgt_his_SAM_regress.coords["models"]):
        con = axs[num_models+2].contourf(
        hgt_his_SAM_regress["slope"].sel(level=lev, models=mod),
        cmap="ColdHot",
        cmap_kw={"left": 0.06, "right": 0.94, "cut": -0.1},
        levels=np.arange(startlim[i], endlim[i]+spacing[i], spacing[i]),
        zorder=0.8,
        ...
        sepl.plt_sig(
            hgt_his_SAM_regress["slope"].sel(level=lev, models=mod), axs[num_models+2], n, np.where(hgt_his_SAM_regress["pvalue"].sel(level=lev, models=mod)[::n, ::n] <= 0.05), "denim", 3.0,
        )
        
        axs[num_models+2].quiver(
        u_his_SAM_regress["slope"].sel(level=lev, models=mod)[::ski, ::ski],
        v_his_SAM_regress["slope"].sel(level=lev, models=mod)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
        ...
        m = axs[num_models+2].quiver(
            u_his_SAM_regress["slope"].sel(level=lev, models=mod).where(wind_his_SAM_regress_mask.sel(level=lev, models=mod) > 0.0)[::ski, ::ski],
            v_his_SAM_regress["slope"].sel(level=lev, models=mod).where(wind_his_SAM_regress_mask.sel(level=lev, models=mod) > 0.0)[::ski, ::ski],
            zorder=1.1,
            headwidth=2.6,
            headlength=2.3,
            headaxislength=2.3,
...
for i, lev in enumerate(hgt_ERA5_SAM_slope.coords["level"]):
    ...
    # ===================================================
    con = axs[0].contourf(
    hgt_ERA5_SAM_rvalue.sel(level=lev),
    cmap="ColdHot",
    cmap_kw={"left": 0.06, "right": 0.94, "cut": -0.1},
    levels=np.arange(startlim[i], endlim[i]+spacing[i], spacing[i]),
    zorder=0.8,
    ...
    sepl.plt_sig(
        hgt_ERA5_SAM_rvalue.sel(level=lev), axs[0], n, np.where(hgt_ERA5_SAM_pvalue.sel(level=lev)[::n, ::n] <= 0.05), "denim", 3.0,
    )
    axs[0].quiver(
        u_ERA5_SAM_rvalue.sel(level=lev)[::ski, ::ski],
        v_ERA5_SAM_rvalue.sel(level=lev)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
    ...
    m = axs[0].quiver(
        u_ERA5_SAM_rvalue.sel(level=lev).where(wind_ERA5_SAM_regress_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        v_ERA5_SAM_rvalue.sel(level=lev).where(wind_ERA5_SAM_regress_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
    ...
    # ===================================================
    # con = axs[1].contourf(
    # hgt_his_SAM_regress_ens["rvalue"].sel(level=lev),
    # cmap="ColdHot",
    # cmap_kw={"left": 0.06, "right": 0.94, "cut": -0.1},
    # levels=np.arange(startlim[i], endlim[i]+spacing[i], spacing[i]),
    # zorder=0.8,
    ...
    # )
    # sepl.plt_sig(
    #     hgt_his_SAM_regress_ens["rvalue"].sel(level=lev), axs[1], n, np.where(hgt_his_SAM_regress_ens_mask.sel(level=lev)[::n, ::n] > 0.0), "denim", 3.0,
    # )
    sepl.plt_sig(
        hgt_his_SAM_regress_ens["slope"].sel(level=lev), axs[1], n, np.where(hgt_his_SAM_regress_ens_mask.sel(level=lev)[::n, ::n] > 0.0), "denim", 3.0,
    )
    ...
    for num_models, mod in enumerate(hgt_his_SAM_regress.coords["models"]):
        con = axs[num_models+2].contourf(
        hgt_his_SAM_regress["rvalue"].sel(level=lev, models=mod),
        cmap="ColdHot",
        cmap_kw={"left": 0.06, "right": 0.94, "cut": -0.1},
        levels=np.arange(startlim[i], endlim[i]+spacing[i], spacing[i]),
        zorder=0.8,
        ...
        sepl.plt_sig(
            hgt_his_SAM_regress["rvalue"].sel(level=lev, models=mod), axs[num_models+2], n, np.where(hgt_his_SAM_regress["pvalue"].sel(level=lev, models=mod)[::n, ::n] <= 0.05), "denim", 3.0,
        )
        m = axs[num_models+2].quiver(
            u_his_SAM_regress["rvalue"].sel(level=lev, models=mod).where(wind_his_SAM_regress_mask.sel(level=lev, models=mod) > 0.0)[::ski, ::ski],
            v_his_SAM_regress["rvalue"].sel(level=lev, models=mod).where(wind_his_SAM_regress_mask.sel(level=lev, models=mod) > 0.0)[::ski, ::ski],
            zorder=1.1,
            headwidth=2.6,
            headlength=2.3,
            headaxislength=2.3,
