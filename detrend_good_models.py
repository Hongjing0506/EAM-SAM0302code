...
his_wj_axis_gens = his_wj_axis.sel(models=gmodels).mean(dim="models", skipna=True)
ssp585_p3_wj_axis_gens = ssp585_p3_wj_axis.sel(models=gmodels).mean(dim="models", skipna=True)
...
sepl.plt_sig(
    pre_diff_India_pre_rvalue_gens, axs[0], n, np.where(pre_diff_India_pre_gens_mask[::n, ::n] > 0.0), "bright purple", 4.0,
)
...
sepl.plt_sig(
    pre_diff_India_pre_slope_gens, axs[0], n, np.where(pre_diff_India_pre_gens_mask[::n, ::n] > 0.0), "bright purple", 4.0,
)
...
for num_lev,lev in enumerate([200.0, 500.0, 850.0]):
    ...
    sepl.plt_sig(
        IndR_diff_hgt_rvalue_gens.sel(level=lev), axs[0], n, np.where(IndR_diff_hgt_gens_mask.sel(level=lev)[::n, ::n] > 0.00), "bright purple", 3.0,
    )
    axs[0].quiver(
    ...
    m = axs[0].quiver(
        IndR_diff_u_rvalue_gens.sel(level=lev).where(IndR_diff_wind_gens_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        IndR_diff_v_rvalue_gens.sel(level=lev).where(IndR_diff_wind_gens_mask.sel(level=lev) > 0.0)[::ski, ::ski],
        zorder=1.1,
        headwidth=2.6,
        headlength=2.3,
        headaxislength=2.3,
...
for num_lev,lev in enumerate([200.0, 500.0, 850.0]):
    ...
    sepl.plt_sig(
        IndR_diff_hgt_slope_gens.sel(level=lev), axs[0], n, np.where(IndR_diff_hgt_gens_mask.sel(level=lev)[::n, ::n] > 0.00), "bright purple", 3.0,
    )
    axs[0].quiver(
